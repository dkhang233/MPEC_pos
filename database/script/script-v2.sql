...
INSERT INTO `people` VALUES ('John','Doe',NULL,'555-555-5555','changeme@example.com','Address 1','','','','','','',1),
('Khang','Danh',1,'012345678','dkhang@gmail.com','HaNoi','','HaNoi','Abc','333','VietNam','',2);
...
INSERT INTO `app_config` (`key`, `value`, `user`) 
VALUES 
('address', '123 Nowhere street', 'admin'), -- Địa chỉ cửa hàng 

-- Setting liên quan đến barcode --
('allow_duplicate_barcodes', '0', 'admin'), -- Cho phép trùng lặp barcode (nhiều sản phẩm có cùng barcode) 
('barcode_content', 'id', 'admin'), -- Nội dung barcode (liên quan đến chức năng tạo barcode của ứng dụng)
('barcode_first_row', 'category', 'admin'), -- Dòng đầu tiên của barcode
('barcode_font', 'Arial', 'admin'), -- Font chữ barcode
('barcode_font_size', '10', 'admin'), -- Size font chữ barcode
('barcode_formats', '[]', 'admin'), -- Định dạng barcode
('barcode_generate_if_empty', '0', 'admin'), -- Tạo barcode nếu trống
('barcode_height', '50', 'admin'), -- Chiều cao barcode
('barcode_num_in_row', '2', 'admin'), -- Số lượng barcode trên 1 hàng
('barcode_page_cellspacing', '20', 'admin'), -- Khoảng cách giữa các barcode (tính theo px)
('barcode_page_width', '100', 'admin'), -- Chiều rộng trang barcode (tính theo %)
('barcode_second_row', 'item_code', 'admin'), -- Dòng thứ 2 của barcode
('barcode_third_row', 'unit_price', 'admin'), -- Dòng thứ 3 của barcode
('barcode_type', 'Code39', 'admin'), -- Loại barcode
('barcode_width', '250', 'admin'), -- Chiều rộng barcode

-- Setting liên quan đến cửa hàng --
('cash_decimals', '2', 'admin'), -- Số lượng số thập phân của tiền mặt
('cash_rounding_code', '1', 'admin'), -- Làm tròn tiền mặt
('category_dropdown', '0', 'admin'), -- Tùy chỉnh cách hiển thị category cho các mặt hàng 
('company', 'Open Source Point of Sale', 'admin'), -- Tên cửa hàng
('email', 'changeme@example.com', 'admin'), -- Email cửa hàng
('fax', '', 'admin'), -- Fax của cửa hàng
('website', '', 'admin'), -- Website của cửa hàng 
('phone', '555-555-5555', 'admin'), -- Sdt của cửa hàng 
('return_policy', 'Test', 'admin'), -- Chính sách trả hàng

-- Setting chung --
('gcaptcha_enable', '0', 'admin'), -- Có bật chức năng captcha hay không
('gcaptcha_secret_key', '', 'admin'), -- Key bí mật để dùng captcha
('gcaptcha_site_key', '', 'admin'), -- Nơi cung cấp captcha
('image_allowed_types', 'jpg|gif|png', 'admin'), -- Định dạng ảnh cho phép upload
('image_max_height', '480', 'admin'),
('image_max_size', '128', 'admin'),
('image_max_width', '640', 'admin'),
('include_hsn', '0', 'admin'), -- Có hỗ trợ mã HSN không
('giftcard_number', 'series', 'admin'), -- Cách tạo giftcard_number
('enforce_privacy', '', 'admin'), -- Có bật chế độ ghi đè dữ liệu của khách hàng không
('default_receivings_discount', '0', 'admin'), -- Giảm giá mặc định khi nhập hàng
('default_receivings_discount_type', '0', 'admin'), -- Loại giảm giá mặc định khi nhập hàng
('default_register_mode', 'sale', 'admin'), -- Chế độ mặc định khi sử dụng chức năng Sales
('default_sales_discount', '0', 'admin'), -- Giảm giá mặc định khi bán hàng
('default_sales_discount_type', '0', 'admin'), -- Loại giảm giá mặc định khi bán hàng
('derive_sale_quantity', '0', 'admin'), -- Số lượng bán
('theme', 'flatly', 'admin'), -- Theme
('lines_per_page', '25', 'admin'),
('line_sequence', '0', 'admin'),
('login_form', 'floating_labels', 'admin'),
('multi_pack_enabled', '0', 'admin'),
('notify_horizontal_position', 'center', 'admin'),
('notify_vertical_position', 'bottom', 'admin'),
('suggestions_first_column', 'name', 'admin'),
('suggestions_second_column', '', 'admin'),
('suggestions_third_column', '', 'admin'),
('receiving_calculate_average_price', '0', 'admin'),

-- Setting liên quan đến internalization --
('company_logo', '', 'admin'), -- Logo cửa hàng
('country_codes', 'vn', 'admin'), -- Mã quốc gia
('currency_code', 'VND', 'admin'), -- Mã tiền tệ
('language', 'english', 'admin'),
('language_code', 'en-US', 'admin'),
('currency_decimals', '0', 'admin'), -- Số lượng số thập phân của tiền tệ
('currency_symbol', '₫', 'admin'), -- Ký hiệu tiền tệ
('dateformat', 'm/d/Y', 'admin'), -- Định dạng ngày
('date_or_time_format', '', 'admin'), -- Định dạng ngày hoặc thời gian
('financial_year', '1', 'admin'), -- Ngày bắt đầu của năm tài chính
('thousands_separator', '1', 'admin'),
('timeformat', 'H:i:s', 'admin'),
('timezone', 'America/New_York', 'admin'),
('tax_decimals', '2', 'admin'),
('number_locale', 'vn_VN', 'admin'),
('payment_options_order', 'cashdebitcredit', 'admin'),
('quantity_decimals', '0', 'admin'),

-- Setting liên quan đến customer reward --
('customer_reward_enable', '1', 'admin'), -- Bật chế độ tích điểm thưởng dành cho khách hàng

-- Setting liên quan đến thuế (tax) --
('default_tax_1_name', '', 'admin'), -- Tên thuế 1
('default_tax_1_rate', '', 'admin'), -- Thuế 1 (tính theo %)
('default_tax_2_name', '', 'admin'), -- Tên thuế 2
('default_tax_2_rate', '', 'admin'), -- Thuế 2 (tính theo %)
('default_tax_category', 'Standard', 'admin'), -- Loại thuế mặc định
('default_tax_code', '', 'admin'), -- Mã thuế mặc định
('default_tax_jurisdiction', '', 'admin'), -- Thuế pháp lý mặc định
('default_tax_rate', '8', 'admin'), -- Thuế mặc định
('tax_id', '', 'admin'),
('tax_included', '0', 'admin'),
('use_destination_based_tax', '0', 'admin'),

-- Setting liên quan đến table --
('dinner_table_enable', '1', 'admin'), -- Có bật chế độ bàn ăn hay không

-- Setting liên quan đến receipt --
('email_receipt_check_behaviour', 'last', 'admin'), -- Mặc định là có gửi email cho khách hàng hay không
('receipt_font_size', '12', 'admin'),
('receipt_show_company_name', '1', 'admin'),
('receipt_show_description', '1', 'admin'),
('receipt_show_serialnumber', '1', 'admin'),
('receipt_show_taxes', '0', 'admin'),
('receipt_show_tax_ind', '0', 'admin'),
('receipt_show_total_discount', '1', 'admin'),
('receipt_template', 'receipt_default', 'admin'),
('print_bottom_margin', '0', 'admin'),
('print_delay_autoreturn', '0', 'admin'),
('print_footer', '0', 'admin'),
('print_header', '0', 'admin'),
('print_left_margin', '0', 'admin'),
('print_receipt_check_behaviour', 'last', 'admin'),
('print_right_margin', '0', 'admin'),
('print_silently', '1', 'admin'),
('print_top_margin', '0', 'admin'),

-- Setting liên quan đến invoice --
('invoice_default_comments', 'This is a default comment', 'admin'), -- Comment mặc định trong invoice
('invoice_email_message', 'Dear {CU}, In attachment the receipt for sale {ISEQ}', 'admin'), 
('invoice_enable', '1', 'admin'), -- Có hỗ trợ invoice hay không
('invoice_type', 'invoice', 'admin'),
('last_used_invoice_number', '0', 'admin'),
('last_used_quote_number', '0', 'admin'),
('last_used_work_order_number', '0', 'admin'),
('recv_invoice_format', '{CO}', 'admin'),
('sales_invoice_format', '{CO}', 'admin'),
('sales_quote_format', 'Q%y{QSEQ:6}', 'admin'),
('quote_default_comments', 'This is a default quote comment', 'admin'),
('work_order_enable', '0', 'admin'),
('work_order_format', 'W%y{WSEQ:6}', 'admin'),
...
('msg_src', '', 'admin'),
('msg_uid', '', 'admin'),
('mailpath', '/usr/sbin/sendmail', 'admin'),
('protocol', 'mail', 'admin'),
('smtp_crypto', 'ssl', 'admin'),
('smtp_host', '', 'admin'),
('smtp_pass', '', 'admin'),
('smtp_port', '465', 'admin'),
('smtp_timeout', '5', 'admin'),
('smtp_user', '', 'admin');
...
INSERT INTO `modules` VALUES ('module_attributes','module_attributes_desc',107,'attributes'),
('module_cashups','module_cashups_desc',110,'cashups'),
('module_config','module_config_desc',900,'config'),
('module_customers','module_customers_desc',10,'customers'),
('module_users','module_users_desc',80,'users'),
...
INSERT INTO `permissions` VALUES ('attributes','attributes',NULL),
...
('giftcards','giftcards',NULL),('home','home',NULL),
('items','items',NULL),
('items_stock','items',1),
...
INSERT INTO `sessions` VALUES ('oarqq99j73fj1fu9vksid5k1m5jrbpfr','::1','admin',1739003413,_binary '__ci_last_regenerate|i:1739003413;person_id|s:1:\"1\";menu_group|s:6:\"office\";allow_temp_items|i:0;item_location|s:1:\"1\";');
...
INSERT INTO `stock_locations` VALUES (1,'stock','admin',0);
