...
public class InventoryModel {
    ...
    private void updateItemFromReceiving(Receivings receiving) {
        ...
        if (existingItem != null) {
            existingItem.setQuantityAtCurrentLocation(
                    existingItem.getQuantityAtCurrentLocation().get() + receiving.getQuantity()
            );
        } else {
            ...
            newItem.getQuantityAtCurrentLocation().set(receiving.getQuantity());
